...
public interface BookingRepository extends JpaRepository<Booking, Long> {
     ...
     */
    List<Booking> findByItemIdAndBookerIdAndStatusAndEndIsBefore(Long itemId,
                                                                 Long bookerId,
...
//    findBy BookerId And EndIsBefore OrderBy Start Desc
//     */
//    List<Booking> findByBookerIdAndEndIsBeforeOrderByStartDesc(Long bookerId,
//                                                               LocalDateTime time,
//                                                               PageRequest pageRequest);
//
//    /*
...
//    findBy BookerId And StartIsAfter OrderBy Start Desc
//     */
//    List<Booking> findByBookerIdAndStartIsAfterOrderByStartDesc(Long userId,
//                                                                LocalDateTime time,
//                                                                PageRequest pageRequest);
//
//    /*
...
//    findBy BookerId And StartIsAfter And Status OrderBy Start Desc
//     */
//    List<Booking> findByBookerIdAndStartIsAfterAndStatusOrderByStartDesc(Long bookerId,
//                                                                         LocalDateTime time,
//                                                                         BookingStatus status,
//                                                                         PageRequest pageRequest);
//
...
//    findBy ItemOwnerId And StartIsAfter OrderBy Start Desc
//     */
//    List<Booking> findByItemOwnerIdAndStartIsAfterOrderByStartDesc(Long ownerId,
//                                                                   LocalDateTime time,
//                                                                   PageRequest pageRequest);
//
//    /*
...
//    findBy ItemOwnerId And StartIsAfter And Status OrderBy Start Desc
//     */
//    List<Booking> findByItemOwnerIdAndStartIsAfterAndStatusOrderByStartDesc(Long ownerId,
//                                                                            LocalDateTime time,
//                                                                            BookingStatus status,
//                                                                            PageRequest pageRequest);
//
